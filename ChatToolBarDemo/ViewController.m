...
@interface ViewController ()<UITableViewDelegate,UITableViewDataSource,ChatToolBarDelegate,UITextFieldDelegate>
...
- (void)tapAction{
    [self.chatToolBar resignKeyboard];
}
...
- (void)keybaordAnimationWithDuration:(CGFloat)duration keyboardOriginY:(CGFloat)keyboardOriginY{
    ...
    [UIView animateWithDuration:duration delay:0 options:UIViewAnimationOptionCurveEaseIn animations:^{
        //text field
        CGPoint textFieldOrigin = _chatToolBar.frame.origin;
        CGSize  textFieldSize = _chatToolBar.frame.size;
        ...
        _chatToolBar.frame = textFieldAimFrame;
...
- (void)textViewDidChange:(UITextView *)textView{
    if ((ChatTextView *)textView == self.chatToolBar.inputTextView) {
        
        [self.chatToolBar textDidChanged];
        CGPoint textViewOrigin = self.chatToolBar.frame.origin;
        CGFloat contentHeight = _tableView.contentSize.height;
